...
def hasG2MeshProperties(obj: bpy.types.Object) -> bool:
    ...
    return (
        ("g2_prop_off" in obj)
        and ("g2_prop_tag" in obj)
        and ("g2_prop_name" in obj)
        and ("g2_prop_shader" in obj)
    )
...
def initG2Properties() -> None:
    ...
    bpy.types.Object.g2_prop_name = bpy.props.StringProperty(
        ...
        maxlen=64,
        default="",
        description="Name (in case it doesn't fit in Blender's Object Name, which is used if this is empty.)",
    )
    bpy.types.Object.g2_prop_shader = bpy.props.StringProperty(
        name="shader",
        maxlen=64,
        default="",
        description="Shader to use (the one and only way to set this)",
    )
    ...
    bpy.types.Object.g2_prop_off = bpy.props.BoolProperty(
        name="Off",
        default=False,
        description="Whether this object should be initially off (can be overridden in skin).",
    )
    bpy.types.Object.g2_prop_scale = bpy.props.FloatProperty(
        ...
        min=0,
        subtype="PERCENTAGE",
        description="Scale of this skeleton.",
    )
